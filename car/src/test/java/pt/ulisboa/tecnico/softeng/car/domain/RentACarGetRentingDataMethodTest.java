...
public class RentACarGetRentingDataMethodTest {
	...
	private static final String PLATE3 = "ZZ-ZZ-ZZ";
	...
	public void success() {
		...
		Vehicle m3 = new Motorcycle(PLATE3, KM, rentCar);
		...
		m3.rent(DRIVINGLICENSE, new LocalDate(2014,4,2) ,  new LocalDate(2014, 7, 2));
