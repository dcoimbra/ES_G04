...
public class HotelRestController {
    ...
    public ResponseEntity<String> reserve(@RequestParam Room.Type type,
        ...
        logger.info("reserve type:{}, arrival:{}, departure:{}, buyerNif:{}, buyerIban:{}", arrival, departure, buyerNif, buyerIban);
        try {
    ...
    public ResponseEntity<String[]> bulk(@RequestParam int number,
        ...
        logger.info("bulk number:{}, arrival:{}, departure:{}, buyerNif:{}, buyerIban:{}", number, arrival, departure, buyerNif, buyerIban);
